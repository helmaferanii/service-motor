<div class="modal fade" id="editUserData-{{ $data->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="container">
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="role" id="radioRole"
                                    value="user" @if ($data->role == 'user') checked @endif>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="role" id="radioRole"
                                    value="admin" @if ($data->role == 'admin') checked @endif>
                                <label class="form-check-label" for="radioRole">
                                    Admin
                                </label>
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="formNumberPon" placeholder="name@example.com"
                                name="no_polisi" value="{{ $data->no_polisi }}">
                        </div>
                        <div class="mb-3">
